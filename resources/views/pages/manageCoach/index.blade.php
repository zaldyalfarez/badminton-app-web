    ...
    <div>
        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Coach</h1>
                <p class="mt-2 text-sm text-gray-700">A list of all the coaches including their name, email, and role.</p>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @forelse ($coaches as $coach)
                                    <tr x-data="{ open_{{ $coach['id'] }}: false }">
                                        <td
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ \Carbon\Carbon::parse($coach['createdAt'])->format('d/m/Y') }}
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ \Carbon\Carbon::parse($coach['updatedAt'])->format('d/m/Y') }}
                                        </td>
                                        <td
                                            class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <div class="inline-flex items-center gap-2">
                                                {{-- Edit --}}
                                                <a href="{{ url('/dashboard/coach/edit/' . $coach['id']) }}"
                                                ...
                                                <div x-show="open_{{ $coach['id'] }}" x-transition
                                                    ...
                                                    <div @click.away="open_{{ $coach['id'] }} = false"
                                                            ...
                                                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                                ...
                                                                <div class="mt-2">
                                                                    <p class="text-sm text-gray-500">
                                                                        Are you sure want to delete this coach
                                                        ...
                                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                            <form method="POST"
                                                                action="{{ route('coach.delete', $coach['id']) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
