...
@section('content')
    ...
    <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow">
        ...
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('question.create', $examId) }}" method="POST" class="p-4">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 grid grid-cols-1">
                            <select id="answer" name="answer" autocomplete="answer-name"
                            ...
                            <div class="overflow-hidden rounded-lg bg-white shadow border border-gray-200">
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        @if ($question)
                                            @foreach ($question as $item)
                                                <tr x-data="{ open: false }">
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        {{ \Illuminate\Support\Str::limit($item['question'], 25) }}
                                                    </td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        {{ $item['answer'] }}
                                                    </td>
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        {{ \Carbon\Carbon::parse($item['updatedAt'])->format('d/m/Y') }}
                                                    </td>
                                                    <td
                                                                    ...
                                                                    <div class="sm:flex sm:items-start">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h3
                                                                                ...
                                                                                Hapus Data</h3>
                                                                            <div class="mt-2">
                                                                                <p class="text-sm text-gray-500">Apakah
                                                                                    kamu yakin ingin menghapus soal ini?</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="7" class="text-center py-4 text-gray-500">Soal tidak
                                                    ditemukan.</td>
                                            </tr>
                                        @endif
                                    </tbody>
